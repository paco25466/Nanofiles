...
/**
 * Clase principal de la aplicación NanoFiles.
 * Punto de entrada del sistema P2P de compartición de ficheros.
 * Inicializa la base de datos de ficheros locales y el controlador
 * que gestiona los comandos del usuario a través del shell interactivo.
 * 
 * @author Redes
 */
public class NanoFiles {
	 ...
	 */
	public static final String PROTOCOL_ID = "54567449H35702654F";
