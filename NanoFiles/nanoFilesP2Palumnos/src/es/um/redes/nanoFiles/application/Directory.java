...
/**
 * Clase principal para iniciar el servidor de directorio.
 * Permite lanzar el servicio de directorio UDP que actúa como
 * punto central de descubrimiento de peers y ficheros compartidos
 * en la red NanoFiles.
 * 
 * @author Redes
 */
