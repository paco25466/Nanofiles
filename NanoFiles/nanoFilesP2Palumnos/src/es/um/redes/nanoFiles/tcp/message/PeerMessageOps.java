...
/**
 * Definición de operaciones del protocolo de mensajes entre peers.
 * Contiene las constantes (opcodes) que identifican los diferentes
 * tipos de mensajes binarios intercambiados entre peers mediante TCP
...
public class PeerMessageOps {
	...
	public static final byte OPCODE_DOWNLOAD_FILE_ACCEPTED = 2;
	 ...
	 */
	private static final Byte[] _valid_opcodes = { OPCODE_INVALID_CODE,OPCODE_DOWNLOAD_FILE,
			OPCODE_DOWNLOAD_FILE_ACCEPTED
