...
/**
 * Controlador de lógica para la comunicación con el directorio.
 * Gestiona todas las operaciones que requieren interacción con
 * el servidor de directorio, incluyendo ping, registro de servidor,
 * consulta de ficheros y búsqueda de peers.
 * 
 * @author Redes
 */
public class NFControllerLogicDir {
	...
	protected void testCommunicationWithDirectory() {
		...
		try{
			...
			System.err.println("[testMode] Communication error: " + e.getMessage());
			e.printStackTrace();
		}
	}
