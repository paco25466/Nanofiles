...
/**
 * Definición de comandos soportados por el shell de NanoFiles.
 * Contiene las constantes que identifican cada comando,
 * los textos de ayuda y métodos para convertir entre
 * cadenas de texto y códigos de comando.
 * 
 * @author Redes
 */
