...
/**
 * Shell interactivo de línea de comandos para NanoFiles.
 * Proporciona la interfaz de usuario para introducir comandos,
 * validar argumentos y mostrar mensajes de ayuda.
 * Lee comandos de la entrada estándar y los procesa.
 * 
 * @author Redes
 */
